...
![Prerequisites: M05 — for & while loops](https://img.shields.io/badge/Prerequisites-M05:_for_%26_while_loops-94a3b8?style=flat-square)
...
**Scenario:** A parking lot owner currently calculates fees on paper at the entrance kiosk. They want a terminal tool staff can use — type in the hours, get the fee instantly — with a daily maximum cap so long-term parkers are never overcharged. We will build a **parking fee calculator** with a tiered pricing model, demonstrating parameters, return values, and reuse.

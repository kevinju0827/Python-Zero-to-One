...
| Layout | Behavior |
|--------|----------|
| `QVBoxLayout` | Stack vertically (top to bottom) |
| `QHBoxLayout` | Arrange horizontally (left to right) |
...
**Scenario:** A friend managing a small restaurant wants wait staff to be able to calculate tips quickly, without typing commands in a terminal. We will build a **tip calculator** —a tiny desktop app they can actually use.
...
# MANUAL FIX NEEDED: delete the duplicate result_label line above this comment

...
![Prerequisites: M02 — variables & input()](https://img.shields.io/badge/Prerequisites-M02:_variables_%26_input()-94a3b8?style=flat-square)
...
**Scenario:** You want a morning script that gives you a specific clothing recommendation — not just the temperature reading, but whether you need a jacket, sunscreen, or an umbrella, based on both heat and rain. We will build a **weather advisor** that makes that call for you.
